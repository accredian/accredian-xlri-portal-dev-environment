...
import PersonalGM from "./Personal-gm";
import ApplicationFee from "./Applicationfee-gm";
...
import AdmissionfeeNew from "./Addmisssiongmfee";
...
const BasicGM = () => {
  ...
  //     }
  //     if (
  //       (step.stepthree == "review" || step.stepthree == "inprocess" || step.stepthree =='pending') &&
